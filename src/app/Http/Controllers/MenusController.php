...
class MenusController extends Controller
{
    public function show()
    {
        ...
        ->select('items.id as item_id','items.name as item_name','items.price as item_price','umenus.id as umenu_id','umenus.name as umenu_name','items.store_id as store_id')
