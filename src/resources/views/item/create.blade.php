                            ...
                            <div class="panel-body">
                                ...
                                <form method="POST" action="/item/store" class="form-horizontal">
                                    {{ csrf_field() }}
                                        ...
                                        <div class="col-md-6">
                                            <input class="form-control" required="required" name="cost" type="text" id="cost" value="{{old('cost')}}">
                                        </div>
                                    </div>
										<div class="form-group">
                                        <label for="price" class="col-md-4 control-label">price: </label>
                                        <div class="col-md-6">
                                            <input class="form-control" required="required" name="price" type="text" id="price" value="{{old('price')}}">
                                        </div>
                                    </div>
										<div class="form-group">
                                        <label for="stock" class="col-md-4 control-label">stock: </label>
                                        <div class="col-md-6">
                                            <input class="form-control" required="required" name="stock" type="text" id="stock" value="{{old('stock')}}">
                                        </div>
                                    </div>
										<div class="form-group">
                                        <label for="description" class="col-md-4 control-label">description: </label>
                                        <div class="col-md-6">
                                            <input class="form-control" required="required" name="description" type="text" id="description" value="{{old('description')}}">
                                        </div>
                                    </div>
										<div class="form-group">
                                        ...
                                        <div class="col-md-6">
                                            <input class="form-control" required="required" name="store_id" type="text" id="store_id" value="{{old('store_id')}}">
                                        </div>
                                    </div>
										<div class="form-group">
                                        <label for="is_addone" class="col-md-4 control-label">is_addone: </label>
                                        <div class="col-md-6">
                                            <input class="form-control" required="required" name="is_addone" type="text" id="is_addone" value="{{old('is_addone')}}">
                                        </div>
                                    </div>
