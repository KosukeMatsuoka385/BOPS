                ...
                <div class="sub-header-group">
                    <div class="sub-header">
                        ...
                        <div class="header_cart order-1">
                            ...
                            <a href="#" id="cart_btn" class="cart__btn hover-btn pull-bs-canvas-left" title="Cart"><i class="uil uil-shopping-cart-alt"></i><span>Cart</span><ins>2</ins><i class="uil uil-angle-down"></i></a>
                        </div>
